...
const meta: Meta<typeof Heading> = {
  ...
  argTypes: {
    ...
    // Built-in `sans`/`mono` only here — see Text's "CustomFonts" story for
    // the open-ended `font` vocabulary.
...
// Interactive default — every knob is tunable from the controls panel.

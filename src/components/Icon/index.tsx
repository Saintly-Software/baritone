 ...
 * (in a flex context the parent's cross-axis alignment governs its placement and
 * `vertical-align` is inert). Horizontal spacing is genuinely context-dependent,
 * so that's still the caller's to set.
 */
